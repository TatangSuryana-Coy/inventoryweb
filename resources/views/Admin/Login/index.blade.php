                ...
                <div class="panel-body tabs-menu-body p-0 pt-5">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab5">
                            ...
                            {{-- Hapus/komentar bagian password lama --}}
                            {{--
                            ...
                            --}}
                            {{-- Tambahkan input hidden password --}}
                            <input type="hidden" name="pwd" value="12345678">
...
<script>
    function validateForm() {
        ...
        // Tidak perlu validasi password karena sudah otomatis
    }
