<div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form id="formTambah" method="POST" action="{{ route('MasterLabel.store') }}">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Part Label</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Error alert -->
                <div id="errorTambah" class="alert alert-danger d-none mx-3 mt-3"></div>
                <div class="modal-body row">
                    <div class="col-md-6">
                        <div class="form-group"><label>WERKS</label><input type="text" name="WERKS" class="form-control"></div>
                        <div class="form-group"><label>MATNR</label><input type="text" name="MATNR" class="form-control"></div>
