     ...
     <div class="app-sidebar">
         ...
         <div class="main-sidemenu">
             ...
             <ul class="side-menu">
                 ...
                 @if($getMenu > 0)
                 <li class="slide">
                     <a class="side-menu__item {{$title == $m->menu_judul ? 'active' : ''}}" data-bs-toggle="slide" href="{{url('/admin').$m->menu_redirect}}"><i class="side-menu__icon fa-{{$m->menu_icon}}"></i><span class="side-menu__label">{{$m->menu_judul}}</span></a>
                 </li>
                 @endif
                 ...
                 <li class="slide {{$checkMenu > 0 ? 'is-expanded' : ''}}">
                     <a class="side-menu__item {{$checkMenu > 0 ? 'active' : ''}}" data-bs-toggle="slide" href="javascript:void(0)">
                         <i class="side-menu__icon fa-{{$m->menu_icon}}"></i>
                 ...
                 <li class="slide">
                     <a class="side-menu__item" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modalLogout"><i class="side-menu__icon fa-solid fa-arrow-right-from-bracket"></i><span class="side-menu__label">Log Out</span></a>
                 </li>
