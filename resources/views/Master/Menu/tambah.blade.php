            ...
            <form method="POST" action="{{ route('menu.store') }}" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <span class="text-gray d-block mb-1">Cari & salin nama dari Icon <a target="_blank" href="https://fontawesome.com/search?ic=free">https://fontawesome.com/</a></span></span>
                        <div class="input-group">
                            <span class="input-group-text bg-gray-light" id="basic-addon1">fa-</span>
